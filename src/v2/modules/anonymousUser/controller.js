...
module.exports = {
  ...
  permissionCodeUpdate: async (req, res) => {
    ...
    try {
      ...
      const getAccount = Database.findOneByQuery(key);
      ...
      const updateRecode = Database.updateRecode(key, { permissionKey: newPermissionKey });
      ...
      // ""
      SUCCESS(res, 200, { newPermissionKey: result1.permissionKey });
