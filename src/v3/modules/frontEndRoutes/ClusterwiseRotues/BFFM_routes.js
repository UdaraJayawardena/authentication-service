...
const FM_Routes = {
  ...
  // }, 
    ...
    {
      name: 'Holding Account Withdrawals',
      icon: 'Dashboard',
      rtlName: '',
      origin: FrontEndUrl.BFFM_PORTAL_URL,
      layout: '/user',
      path: '/holding-account-withdrawal',
      component: 'HoldingAccountWithdrawals',
      cluster: 'FunderManagement',
      permission: 'FM-loan-redemption-overview',
      hide: false
    }],
  ...
  // },
    ...
    {
      name: 'Yearly Statement Overview',
      icon: 'Note',
      rtlName: '',
      origin: FrontEndUrl.BFFM_PORTAL_URL,
      layout: '/admin',
      path: '/yearly-statement-overview',
      component: 'SendYearlyStatements',
      cluster: 'FunderManagement',
      permission: 'FM-yearly-statement-overview',
      hide: false
    },]
};
